...
function App() {
  ...
  const [sandboxQuestion, setSandboxQuestion] = useState(
    PRESET_AI_QUESTIONS[0],
  );
  const [sandboxParentAns, setSandboxParentAns] = useState(
    "Bố mẹ muốn con tập trung học hành chăm chỉ, thi đỗ trường chuyên lớp chọn để sau này đỡ khổ. Bố mẹ đi làm vất vả cũng chỉ vì tương lai của con thôi.",
  );
  const [sandboxParentEmo, setSandboxParentEmo] = useState("anxious");
  const [sandboxChildAns, setSandboxChildAns] = useState(
            ...
            <section
              ...
              <div style={{ textAlign: "center", marginBottom: "24px" }}>
                ...
                <h3 style={{ fontSize: "24px", marginTop: "10px" }}>
                  Hộp Cát Trải Nghiệm AI
                </h3>
                <p style={{ color: "var(--text-muted)", fontSize: "14px" }}>
                  Thử nhập đáp án giả lập của cha mẹ và con cái để xem AI thấu
                  cảm phân tích và đưa ra lời khuyên dịu mát như thế nào!
                </p>
              </div>
                ...
                <div>
                  ...
                  <div className="form-group">
                    ...
                    >
                      ...
                      {["happy", "anxious", "hopeful", "stressed"].map(
                        (emo) => (
                          <button
                          ...
                          >
                            {getEmotionIcon(emo).emoji}{" "}
                            {getEmotionIcon(emo).text}
                          </button>
                        ),
                      )}
                    </div>
